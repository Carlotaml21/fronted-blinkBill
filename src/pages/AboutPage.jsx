...
const AboutPage = () => {
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-6 py-12">
      <h1 className="text-3xl font-bold text-[#26BFBF] mb-8 text-center">Sobre Nosotros</h1>

      <div className="max-w-3xl space-y-6 text-center text-[#1D3440]">
        <p>
      ...
      <p className="mt-12 text-center text-[#1D3440] font-bold">
