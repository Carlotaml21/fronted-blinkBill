    ...
    <div className="min-h-screen bg-white px-6 py-12">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div>
          ...
          <h1 className="text-5xl font-bold text-[#1D3440]">
            <span className="text-[#26BFBF]">Tu privacidad</span> también cuenta
          </h1>
        </div>

       
        <p className="text-[#1D3440] text-xl max-w-3xl">
          En <span className="text-[#26BFBF]"> BlinkBill</span> , creemos que la transparencia no solo debe aplicarse a los datos empresariales,
          sino también a cómo tratamos tu información personal.
        </p>

    
        <div className="text-[#1D3440] space-y-6 text-justify text-s leading-relaxed">
          <p>
            Valoramos la transparencia y el respeto por la privacidad de los usuarios. Por ello,
          ...
          <p>
            La información accesible desde <span className="text-[#26BFBF]"> BlinkBill</span>  proviene de fuentes públicas o de empresas que han
          ...
          <p>
            En <span className="text-[#26BFBF]"> BlinkBill</span>  no existe cesión, tratamiento ni almacenamiento de datos personales. Tampoco se
